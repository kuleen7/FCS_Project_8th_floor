      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="rounded border bg-white p-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            ...
            <input id="company-name" name="name" value={formData.name} onChange={handleInputChange} placeholder="Company name" className="w-full rounded border px-3 py-2" required />
            <label htmlFor="company-location" className="sr-only">Location</label>
            <input id="company-location" name="location" value={formData.location} onChange={handleInputChange} placeholder="Location" className="w-full rounded border px-3 py-2" />
            <label htmlFor="company-website" className="sr-only">Website</label>
            <input id="company-website" name="website" value={formData.website} onChange={handleInputChange} placeholder="Website" className="w-full rounded border px-3 py-2" />
            <label htmlFor="company-description" className="sr-only">Description</label>
            <textarea id="company-description" name="description" value={formData.description} onChange={handleInputChange} placeholder="Description" className="w-full rounded border px-3 py-2" />
